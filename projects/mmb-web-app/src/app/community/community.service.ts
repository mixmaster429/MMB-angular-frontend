...
export class CommunityService {
    ...
    getPage(slug: string): Observable<Page> {
        const url = `${environment.domain}${environment.api.media.pages}/${slug}`;
    ...
    getBlog(): Observable<Blog> {
        const url = `${environment.domain}${environment.api.media.mediaPage}`;
    ...
    getBlogsByCategory(slug: string): Observable<Blog[]> {
        const url = `${environment.domain}${environment.api.media.category}/${slug}`;
    ...
    */
    ...
    addBlogReaction(blogId: number, reactionType: number) {
        ...
        let url = `${environment.domain}${environment.api.media.reaction}`;
    ...
    updateBlogReaction(blogId: number, reactionType: number, reactionUuid: string) {
        ...
        let url = `${environment.domain}${environment.api.media.reaction}${reactionUuid}/`;
    ...
    postNewComment(comment: string, blogId: number) {
        ...
        const url = `${environment.domain}${environment.api.media.comment}`;
